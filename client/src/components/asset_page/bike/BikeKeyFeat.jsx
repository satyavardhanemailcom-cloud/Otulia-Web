...
const BikeKeyFeatures = ({ item }) => {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-4 md:px-8 py-6 bg-white font-sans">
      
      <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6 lg:gap-12">
        
        {/* Heading */}
        <h2 className="text-2xl md:text-3xl font-bold font-serif text-black whitespace-nowrap min-w-fit">
          Key Specifications :
        </h2>
