...
const Estate_Search = () => {
  ...
  return (
    <div className="w-full flex justify-center p-4">
      ...
      {/* MAIN CONTAINER */}
      {/* Desktop: Long pill shape with border. Mobile: Rounded rectangle with shadow. */}
      <div className="
        w-full max-w-[900px]
        bg-white 
      ...
      ">
        ...
        <div className="w-full md:flex-1 relative">
          <input
            ...
            placeholder="Search By Location ( Country Or State )"
            className="
              w-full h-14 md:h-16 
              px-6 
        ...
        ">
          ...
          <button
            ...
            className={`
              ...
              ${activeType === 'Buy' 
                ? 'bg-[#C5A059] text-black' // Active Gold (Matches image)
        ...
        {/* DIVIDER (Desktop Only - before search button) */}
        {/* Note: The image shows the Search button attached directly, but a divider helps visual separation if needed. 
            Based on image, the Search button is a solid block, so we don't need a divider line here. */}
