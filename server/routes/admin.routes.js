...
router.get("/users", authMiddleware, adminCheck, async (req, res) => {
    try {
        ...
        const formattedUsers = users.map(u => ({
            ...
            role: u.role,
            plan: u.plan,
            status: u.verificationStatus === 'Verified' ? 'Active' : 'Pending',
            joinDate: u.createdAt,
            revenue: Math.floor(Math.random() * 5000), // Mock revenue generated by user
...
router.get("/partners", authMiddleware, adminCheck, async (req, res) => {
    try {
        ...
        const formattedPartners = partners.map(p => ({
            ...
            name: p.name,
            email: p.email,
            category: 'General', // Default, logic to determine category could be added
            ...
            totalSales: Math.floor(Math.random() * 1000000), // Mock data
